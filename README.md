...
- [tmux-claude](https://github.com/niklasmoeller/tmux-claude) - Display any claude code status information (including token rate limits) from your claude code session in your statusbar or pane border.
